...
export default function CvCard({ pdfPath = '/Jainam_Jain_SDE.pdf', title = 'SDE', role = 'Software Developer' }) {
  ...
  return (
    ...
    >
      ...
      <a href={pdfPath} download aria-label="Download CV" className="duration-300 hover:bg-sky-900 border bg-gray-50 font-semibold text-sky-800 px-3 py-2 flex flex-row items-center gap-3 rounded">
        Download CV
